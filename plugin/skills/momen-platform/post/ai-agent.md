...
| Duplicate an agent with its output types | `DUPLICATE_ZAI_CONFIG` | `sourceZAiConfigId` |
...
```bash
npx -y momen-mcp@2.7.0 platform graphql --query '{ supportedCustomModelDescriptor { chatModelDescriptors } }'
```
